    ...
    return (
        <article className='post1'>
            <div className="post1__main">
                <div className="post1__information">
                    <p className='post1__date'>{obj.date}</p>
                    <h2 className='post1__title'>{obj.title}</h2>
                    <p className='post1__description'>{obj.description}</p>
                </div>
                <div className="post1__image">
                    <img src={obj.image} alt="image" />
                </div>
            </div>
            <div className="post1__icons">
